...
export function SearchResultPage() {
    ...
    const { data: products = [], isLoading, error } = useFilteredProducts(q);

    if (isLoading) {
        return (
            <div className="p-8">
                <div className="bg-white shadow rounded-2xl p-10 text-center">
                    <p className="text-xl text-gray-600">Ищем товары...</p>
                </div>
            </div>
        );
    }
            ...
            <div className="max-w-7xl mx-auto p-6">
                ...
                <div className="bg-red-50 border border-red-200 rounded-2xl p-8 text-center">
                    <p className="text-red-600 text-lg">
                        {error ? error.message : 'Товары не найдены'}
                    </p>
                </div>
            </div>
        );
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {products.map((product) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="p-5 flex flex-col flex-1">
                                ...
                                <div className="mt-3 space-y-2 text-sm text-gray-600">
                                    {product.oem && (
                                        <p>
                                            OEM: <span className="font-medium text-gray-700">{product.oem}</span>
                                        </p>
                                    )}
                        ...
                        {Array.isArray(product.applicability)
